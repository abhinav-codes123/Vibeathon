...
| Staff authorization | Pass locally | Invite-first manager/owner hierarchy, verified acceptance, active-membership filter, automatic landing, stage ownership, and protected workspaces implemented |
